<div class="admin-container" style="margin-top: 5rem;">
    <div class="admin-header">
        <h2 style="color: white; font-size: 1.8rem; margin: 0;">Add New Menu Item</h2>
    ...
    <form action="add-menu.php" method="POST" enctype="multipart/form-data" class="admin-form">
        ...
        <div class="form-group" style="margin-bottom: 1.8rem;">
            <label for="image" style="display: block; margin-bottom: 0.6rem; font-weight: 500; color: #2c3e50; font-size: 0.95rem;">Image</label>
